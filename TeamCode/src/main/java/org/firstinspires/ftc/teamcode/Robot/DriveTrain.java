...
public class DriveTrain extends LinearOpMode
{
    ...
    public void drive(double power, IMU imu, int angle)
    {
...
//
    ...
    public void pivotTurn(double distance, double power, boolean rightSide, LinearOpMode runSide)
    {
        int ticks = inchesToTicks(distance);

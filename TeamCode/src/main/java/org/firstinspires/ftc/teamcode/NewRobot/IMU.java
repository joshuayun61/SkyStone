...
public class IMU extends LinearOpMode {
    ...
    public IMU(Telemetry telemetry, HardwareMap hardwareMap, DriveTrain driveTrain){}
    ...
    public void imuSetup()
    {
        ...
        parameters.mode = BNO055IMU.SensorMode.NDOF; // added new
...
//    }
     ...
     */
    double error;
    public double PISend(int angle, boolean isRight)
    {
        double distance;
        if(!isRight) // leftTurn
        {
        ...
        {
            distance = 360 - (angle - currentAngle());
            if(distance > 360)
